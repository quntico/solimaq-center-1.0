    ...
    >
      <div className="flex items-center gap-4 mb-6">
        <IconPicker
          ...
          trigger={
            <div className={cn(
              "p-3 bg-primary/10 rounded-lg border border-primary/20 text-primary",
              isEditorMode && "cursor-pointer hover:bg-primary/20 hover:border-primary/50 transition-all"
            )}>
